...
from code.Const import C_GRAY, WIN_HEIGHT, C_BBLUE, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, EVENT_TIMEOUT, \
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if isinstance(ent, (Player, Enemy)):
                    ...
                    if ent.name == 'Player1':
                        self.level_text(15, f'PLAYER 1 - HEALTH: {ent.health} | SCORE: {ent.score}', C_YELLOW,
                                        (370, 10))
                    if ent.name == 'Player2':
                        self.level_text(15, f'PLAYER 2 - HEALTH: {ent.health} | SCORE: {ent.score}', C_YELLOW,
                                        (370, 25))
